...
window.IMB_PRODUCTS = (function () {
  ...
  const fields = [
    ...
    { key: 'consumo_concreto',  label: L('Consumo Máx. de Concreto',    'Max. Concrete Consumption',   'Consumo Máx. de Concreto'),        type: 'number', unit: 'm³/m', group: 'cap' },
    ...
    { key: 'horimetro',         label: L('Horímetro',                   'Hourmeter',                   'Horómetro'),                       type: 'bool', group: 'tech' },
    { key: 'suspensao',         label: L('Suspensão',                   'Suspension',                  'Suspensión'),                      type: 'text', group: 'tech' },
    { key: 'embreagem_radial',  label: L('Embreagem Radial',            'Radial Clutch',               'Embrague Radial'),                 type: 'bool', group: 'tech' },
    { key: 'sensor_altura',     label: L('Sensor de Altura',            'Height Sensor',               'Sensor de Altura'),                type: 'bool', group: 'tech' },
    { key: 'sensor_direcao',    label: L('Sensor de Direção',           'Steering Sensor',             'Sensor de Dirección'),             type: 'bool', group: 'tech' },
    { key: 'sensor_inclinacao', label: L('Sensor de Inclinação',        'Inclination Sensor',          'Sensor de Inclinación'),           type: 'bool', group: 'tech' },
    { key: 'monitoramento_3d',  label: L('Monitoramento 3D',            '3D Monitoring',               'Monitoreo 3D'),                    type: 'bool', group: 'tech' },
    ...
    { key: 'produtividade',     label: L('Produtividade',               'Productivity',                'Productividad'),                   type: 'number', unit: 'm/min', group: 'prod' },
  ];
  ...
  const products = [
    // ===== LINHA HIDRÁULICA — Pavimentadoras de Formas Deslizantes =====
    {
      ...
      specs: {
        ...
        redutor:           null,
        transmissao:       L('Hidráulica integral 3WD','Hydraulic integral 3WD','Hidráulica integral 3WD'),
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: 2,
        largura_perfil: 1200, altura_perfil: 350, consumo_concreto: null,
        peso: 2500, comprimento: 3470, largura: 2410, altura: 1910,
        tanque_combust: 50, tanque_hidr: 100, tanque_agua: null,
        horimetro: true, suspensao: null, embreagem_radial: false,
        sensor_altura: true, sensor_direcao: true, sensor_inclinacao: true,
        monitoramento_3d: true, inset_offset: false,
        esteiras_aco: false, direcao_auto: true, sensores_auto: true,
        partida_eletrica: true, embreagem: false,
        produtividade: null,
      },
    },
    {
      ...
      specs: {
        ...
        redutor:           null,
        transmissao:       L('Hidráulica integral 3WD em esteiras de aço','Hydraulic 3WD on steel tracks','Hidráulica 3WD en orugas de acero'),
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: 4,
        largura_perfil: 2000, altura_perfil: 350, consumo_concreto: null,
        peso: 7500, comprimento: 6900, largura: 2550, altura: 2800,
        tanque_combust: 150, tanque_hidr: 200, tanque_agua: 390,
        horimetro: true, suspensao: null, embreagem_radial: false,
        sensor_altura: true, sensor_direcao: true, sensor_inclinacao: true,
        monitoramento_3d: true, inset_offset: false,
        esteiras_aco: true, direcao_auto: true, sensores_auto: true,
        partida_eletrica: true, embreagem: false,
        produtividade: null,
      },
    },
    ...
    },
    {
      ...
      specs: {
        ...
        redutor:           null,
        transmissao:       L('Hidráulica integral 4WD em esteiras de aço','Hydraulic 4WD on steel tracks','Hidráulica 4WD en orugas de acero'),
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: 10,
        largura_perfil: 4600, altura_perfil: 350, consumo_concreto: null,
    ...
    // ===== LINHA AUTOMATIZADA =====
    {
      ...
      specs: {
        ...
        redutor:           null,
        transmissao:       L('Hidráulica com sensores eletrônicos','Hydraulic with electronic sensors','Hidráulica con sensores electrónicos'),
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: null,
        largura_perfil: 1500, altura_perfil: 450, consumo_concreto: null,
    ...
    // ===== LINHA MECÂNICA — LINHA LEVE =====
    {
      ...
      specs: {
        ...
        redutor:           null,
        transmissao:       L('Manual','Manual','Manual'),
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: null,
        largura_perfil: 280, altura_perfil: 300, consumo_concreto: null,
        peso: 330, comprimento: 2520, largura: 600, altura: 990,
        tanque_combust: null, tanque_hidr: null, tanque_agua: null,
        horimetro: true, suspensao: null, embreagem_radial: false,
        sensor_altura: false, sensor_direcao: false, sensor_inclinacao: false,
        monitoramento_3d: false, inset_offset: false,
        esteiras_aco: false, direcao_auto: false, sensores_auto: false,
        partida_eletrica: true, embreagem: false,
        produtividade: null,
      },
    },
    {
      ...
      specs: {
        ...
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: null,
        largura_perfil: 450, altura_perfil: 300, consumo_concreto: null,
    ...
    // ===== LINHA MECÂNICA — LINHA MÉDIA =====
    {
      ...
      specs: {
        ...
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: null,
        largura_perfil: 1200, altura_perfil: 450, consumo_concreto: null,
    ...
    },
    {
      ...
      specs: {
        ...
        tanque_combust: null, tanque_hidr: null, tanque_agua: null,
        horimetro: true, suspensao: null, embreagem_radial: true,
        sensor_altura: false, sensor_direcao: false, sensor_inclinacao: false,
        monitoramento_3d: false, inset_offset: false,
        esteiras_aco: false, direcao_auto: false, sensores_auto: false,
        partida_eletrica: true, embreagem: true,
        produtividade: null,
      },
    },
    ...
    // ===== LINHA MECÂNICA — LINHA ESPECIAL =====
    {
      ...
      specs: {
        ...
        partida:           L('Elétrica','Electric','Eléctrica'),
        vibradores: null,
        largura_perfil: 1800, altura_perfil: 600, consumo_concreto: null,
