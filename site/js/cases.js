  ...
  const cases = [
    {
      ...
      location: L('Guaratuba — Paraná', 'Guaratuba — Paraná, Brazil', 'Guaratuba — Paraná, Brasil'),
    ...
    },
    {
      ...
      location: L('Curitiba — PR', 'Curitiba — Brazil', 'Curitiba — Brasil'),
      region: L('Sul', 'South', 'Sur'),
      year: '2019 — 2022',
    ...
    },
    {
      ...
      location: L('BR-101 Sul — SC', 'BR-101 South — Brazil', 'BR-101 Sur — Brasil'),
      region: L('Sul', 'South', 'Sur'),
      year: '2017 — 2021',
      status: L('Concluída', 'Completed', 'Concluida'),
      featured: false,
    ...
    },
    {
      ...
      location: L('Florianópolis — SC', 'Florianópolis — Brazil', 'Florianópolis — Brasil'),
      region: L('Sul', 'South', 'Sur'),
      year: '2018',
      status: L('Concluída', 'Completed', 'Concluida'),
      featured: false,
    ...
    },
    {
      ...
      location: L('Joinville — SC', 'Joinville — Brazil', 'Joinville — Brasil'),
      region: L('Sul', 'South', 'Sur'),
      year: '2020 — 2022',
      status: L('Concluída', 'Completed', 'Concluida'),
      featured: false,
    ...
    },
    {
      ...
      location: L('Grande SP', 'Greater São Paulo', 'Gran São Paulo'),
